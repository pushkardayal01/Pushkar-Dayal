...
//Login page
 ...
 await tab.waitForTimeout(3000);
  ...
  await tab.click(".glyphsSpriteCircle__outline__24__grey_2");
  //await tab.click(".glyphsSpriteCircle__outline__24__grey_2 u-__7");
  await tab.click(".rIacr");
  await tab.waitForTimeout(5000);
  await tab.click(".aOOlW.bIiDR");
  await tab.type(".Igw0E.IwRSH.eGOV_.vwCYk.ItkAi","hiiiii this message is send by computer....");
  await tab.waitForTimeout(5000);
  //rIacr  sqdOP yWX7d    y3zKF
